...
import com.springboot.service.office.OfficeInsertService;
 ...
 */
@Service
public class OfficeInsertServiceImpl implements OfficeInsertService {
    @Autowired
    OfficeDao officeDaoImpl;

    @Override
    public int officeInsert(Office office) {
        return officeDaoImpl.officeInsert(office);
    }
}
